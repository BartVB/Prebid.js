...
/***/ function(module, exports, __webpack_require__) {
	...
	var CriteoAdapter = __webpack_require__(2);
	...
	var OpenxAdapter = __webpack_require__(11);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CONSTANTS = __webpack_require__(3);
	var utils = __webpack_require__(4);
	var bidfactory = __webpack_require__(5);
	var bidmanager = __webpack_require__(6);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * This adapter assumes a flat CPM per ad unit if an ad is returned.
	 *
	 ...
	 * @param {integer} options.unit - Auid of ad unit, from OpenX inventory
	 *
	 * @returns {{callBids: _callBids}}
	 * @constructor
	 */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var utils = __webpack_require__(4),
		bidfactory = __webpack_require__(5),
		bidmanager = __webpack_require__(6),
				...
				adloader.loadScript(scriptUrl, function() {
					...
					POX.addHook(function(response) {
						...
						for (i = 0; i < bids.length; i++) {
							...
							if (adUnit.get('pub_rev') || (bid.unit_cpm && adUnit.get('html') && !adUnit.get('is_fallback'))) {
